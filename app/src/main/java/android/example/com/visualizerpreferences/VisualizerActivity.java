...
public class VisualizerActivity extends AppCompatActivity {
    ...
    private void setupSharedPreferences() {
        ...
        mVisualizerView.setShowBass(sharedPreferences.getBoolean(getString(R.string.key), getResources().getBoolean(R.bool.defaultValue)));
        mVisualizerView.setShowMid(getResources().getBoolean(R.bool.defaultValue));
        mVisualizerView.setShowTreble(getResources().getBoolean(R.bool.defaultValue));
